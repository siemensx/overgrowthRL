...
class PlayerState {
    ...
    int ping;
    void f();
array<PlayerState>@ GetPlayerStates();
...
class IMMouseOverFadeIn {
    ...
    void f();
    void f();
class IMMouseOverSound {
    IMMouseOverSound@ f(const string &in audioFile);
    IMMouseOverSound@ opCast();
    IMMouseOverBehavior@ opImplCast();
    void f();
    void f();
class IMFixedMessageOnClick {
    ...
    void f();
    void f();
class IMSoundOnClick {
    IMSoundOnClick@ f(const string &in audioFile);
    IMSoundOnClick@ opCast();
    IMMouseClickBehavior@ opImplCast();
    void f();
    void f();
    void OnClickCallback();
class IMFuncOnClick {
    IMFuncOnClick@ f(OnClickCallback@ func);
    IMFuncOnClick@ opCast();
    IMMouseClickBehavior@ opImplCast();
    void f();
    void f();
class IMElement {
...
void ImGui_BeginDisabled(bool is_disabled); // void ImGui_BeginDisabled(bool is_disabled)
void ImGui_EndDisabled(); // void ImGui_EndDisabled()
...
void ImGui_PushID(const string &in str);
void ImGui_PushID(const ? &in ptr_id);
void ImGui_PushID(int int_id);
void ImGui_PopID();
uint ImGui_GetID(const string &in str_id);
uint ImGui_GetID(const ? &in ptr_id);
...
enum ImGuiCol_ {
    ...
    ImGuiCol_CloseButton = 21,
    ImGuiCol_CloseButtonHovered = 22,
    ImGuiCol_CloseButtonActive = 23,
    ...
    ImGuiCol_ModalWindowDarkening = 52,
    ImGuiCol_COUNT = 53,
enum ImGuiStyleVar_ {
    ...
    ImGuiStyleVar_ChildWindowRounding = 7,
